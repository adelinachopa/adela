...
class Menu:
    def __init__(self, screen):
        ...
        # Фоновое изображение
        self.background = load_image("image/sprite/main_page.jpg", setting.SCREEN_WIDTH, setting.SCREEN_HEIGHT)

        # Кнопка "Играть" (изображение)
        self.button_rect = pygame.Rect(0, 0, 200, 60)
        self.button_rect.center = (setting.SCREEN_WIDTH // 2, setting.SCREEN_HEIGHT // 2 + 45)
        ...
        self.title_rect = self.title_text.get_rect(center=(setting.SCREEN_WIDTH // 2, setting.SCREEN_HEIGHT // 4))
